...
public class DMLTest {
	...
	public void deleteUserTest() throws SQLException{
		...
		User user = new User("ezen2", "0111", "ezen2", "ezen2@gmail.com", new Date(), "fb", new Date());
...
//	 	assertTrue(user.equals(user2));
	...
	// 매개변수로 받은 사용자 정보로 t_user ㅌ[ㅇ;ㅂ,ㄹㅇ,ㄹ update하는 메서드
	public int updateUser(User user) throws SQLException {
		Connection conn = ds.getConnection();
		String sql = "update t_user " + "set pw = ?, name = ?, email = ?, birth = ?, sns = ?, reg_date = ? " + "where id = ? ";
